    ...
    <div className='Landing'>
        ...
        <section className='HeroSection'>
            <div className='HeroMsg'>
                Unlimited And High Quality<br/>Movies in one place<br/>
            </div>

            <span className='SupportMsg'>
                We provide what you suggest<br/>
            </span>
        </section>

        <form onSubmit={handle} className='EmailForm'>
            <input type="email" name = 'uemail' placeholder='Email Address' className='Email'/>
    ...
    <div>
        ...
        <div className='Landing2'>
            ...
            <div>
                ...
                <button onClick={handleCompleteAuthentication} className='NextButton'>Next</button>
                <button onClick={handleChangeEmail} className='UseAnotherEmail'>Use Another Email address</button>
            </div>
        </div>
    </div>
)
