    ...
    <div>
        ...
        <div className='AvailablePlans'>
            <div className='AvailablePlansContent'>
                ...
                <input type="text" name="radionam" value="whatever" className='AvailablePlanRadioBtn' disabled/>
                ...
                <button className='SignIn'>Choose this plan</button>

                </label>
            </div>
            {plans.map(plan=><ListPlan planName = {plan.planName} monthlyPrice = {plan.monthlyPrice} noOfDevice = {plan.noOfDevice} key= {plan._id} />)}
        </div>   
